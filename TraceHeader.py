...
# Output video paths (can be overridden by CLI)
outputVideoPath = None  # Will default to '../Videos/Video.mp4' if None
outputVideoPathFinal = None  # Will default to '../Videos/Video1.mp4' if None
