...
# Court dimensions (fixed for standard tennis court proportions)
widthP = int(967)
heightP = int(1585)
...
def showLines(frame):
    ...
    rectangle(
        frame,
        (xOffset, yOffset),
        (courtWidth + xOffset, courtHeight + yOffset),
        (255, 255, 255),
        2,
    )
    rectangle(
        frame,
        (xOffset, yOffset + int(courtHeight * 0.5)),
        (courtWidth + xOffset, yOffset + int(courtHeight * 0.5)),
        (255, 255, 255),
        2,
    )
    rectangle(
        frame,
        (xOffset + int(courtWidth * 0.124886), yOffset),
        (courtWidth + xOffset - int(courtWidth * 0.124886), courtHeight + yOffset),
        (255, 255, 255),
        2,
    )
    rectangle(
        frame,
        (xOffset + int(courtWidth * 0.124886), yOffset + int(courtHeight * 0.23054)),
        (
            courtWidth + xOffset - int(courtWidth * 0.124886),
            courtHeight + yOffset - int(courtHeight * 0.23054),
        ),
        (255, 255, 255),
        2,
    )
    rectangle(
        frame,
        (xOffset + int(courtWidth * 0.5), yOffset + int(courtHeight * 0.23054)),
        (
            courtWidth + xOffset - int(courtWidth * 0.5),
            courtHeight + yOffset - int(courtHeight * 0.23054),
        ),
        (255, 255, 255),
        2,
...
def showPoint(frame, M, point):
    ...
    circle(
        frame,
        (int(transformed[0]), int(transformed[1])),
        radius=0,
        color=(0, 0, 255),
        thickness=25,
    )
